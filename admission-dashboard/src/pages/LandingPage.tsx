...
const programs = [
  {
    ...
    description:
      "Explore the wonders of medicine, nursing, pharmacy, and allied health professions. Our comprehensive programs prepare you for a rewarding career in healthcare.",
    duration: "4-6 Years",
    image:
  ...
  },
  {
    ...
    description:
      "Build the future with cutting-edge programs in engineering, computer science, and information technology. Innovation starts here.",
    duration: "4-5 Years",
    image:
  ...
  },
  {
    ...
    description:
      "Pioneer sustainable agriculture and food security. Our programs blend traditional farming with modern agricultural technology.",
    duration: "4 Years",
    image:
  ...
  },
  {
    ...
    description:
      "Master the art of business and leadership. Our programs develop strategic thinkers ready for the global marketplace.",
    duration: "4 Years",
    image:
  ...
  },
  {
    ...
    description:
      "Discover the science of living well. Our programs focus on nutrition, family studies, textiles, and consumer sciences.",
    duration: "4 Years",
    image:
...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setAnimatedStats(
        stats.map((stat) =>
          Math.min(Math.round(stat.value * (step / steps)), stat.value),
        ),
      );
        ...
        <div className="container">
          ...
          >
            ...
            <p className="hero-subtitle">
              Join a community of achievers and leaders
            </p>
          ...
          <div className="about-content">
            ...
            >
              ...
              <p className="about-description">
                Since our founding in 1995, Excellence Academy has been
                committed to providing world-class education that empowers
                students to achieve their full potential. Our holistic approach
                combines academic excellence with character development.
              </p>
              <p className="about-description">
                We believe in nurturing critical thinking, creativity, and
                leadership skills that prepare our graduates for the challenges
                of tomorrow.
              </p>
            ...
            {programs.map((program, index) => (
              ...
              >
                ...
                <div className="program-content">
                  ...
                  <Link to="/apply" className="program-link">
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <MapPin size={14} /> 123 Education Avenue
                </li>
                <li>
                  <Phone size={14} /> +1 (555) 123-4567
                </li>
                <li>
                  <Mail size={14} /> admissions@ea.edu
                </li>
              </ul>
            </div>
          </div>
